...
public class Modelo
{
 ...
 public static Object3D cargarModeloMTL(Context contexto, String archivo, String material,float escala) {
     Object3D modelo=null;
     try {
       InputStream is = contexto.getAssets().open(archivo);
 ...
 public static Object3D cargarModelo3DS(Context contexto, String archivo, float escala) {
   Object3D modelo=null;
   try {
     InputStream is = contexto.getAssets().open(archivo);
